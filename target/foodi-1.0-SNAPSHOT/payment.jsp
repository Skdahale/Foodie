    ...
    <body>
        ...
        <aside id="sidebar" class="sidebar">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <form action="admin_payments" class="nav-link " >
                        <button type="submit" class="sidebut">
                ...
                <li class="nav-item">
                    <form action="admin_announcement" class="nav-link collapsed" >
                        <button type="submit" class="sidebut">
        ...
        <main id="main" class="main">
            ...
            <section class="section profile">
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 align="left" class="card-title">Maintainance Bill</h5>
                        ...
                        <form action="maintainance_forward" class="">
                            <div align="left" class="ms-3">
                                <label for="inputDate" class="form-label">Due Date</label>
                                <input type="date" name="due" class="form-control" id="inputDate" required>
                            </div>
                            <div class=" d-flex justify-content-start btns mt-3 mb-3">
                                <button class="btn btn-outline-danger ms-3 cfb" type="reset">Change Format</button>
                                <button class="btn btn-outline-primary ms-3" type="submit">Forward</button>
                            </div>
                        </form>
                        <form action="maintainancebill" class="changeformat container-fluid">
                            <div class="row">
                                <div class="mb-3 col-lg-4 ">
                                    ...
                                    <div class="input-group has-validation">
                                        ...
                                        <input type="number" name="general" class="form-control"
                                ...
                                <div class="mb-3 col-lg-4">
                                    ...
                                    <div class="input-group has-validation">
                                        <span class="input-group-text" id="inputGroupPrepend"><i
                                                class="bi bi-currency-rupee"></i></span>
                                        <input type="number" class="form-control" name="muncipal"
                                               id="validationCustomUsername" aria-describedby="inputGroupPrepend"
                                               placeholder="muncipal tax" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 col-lg-3">
                                    ...
                                    <div class="input-group has-validation">
                                        ...
                                        <input type="number" class="form-control" id="validationCustomUsername"
                                               name="electricity" aria-describedby="inputGroupPrepend"
                                ...
                                <div class="mb-3 col-lg-3">
                                    ...
                                    <div class="input-group has-validation">
                                        <span class="input-group-text" id="inputGroupPrepend"><i
                                                class="bi bi-currency-rupee"></i></span>
                                        <input type="number" class="form-control" id="validationCustomUsername"
                                               name="parking" aria-describedby="inputGroupPrepend"
                                               placeholder="parking charges" required>
                                    </div>
                                </div>
                                <div class="mb-3 col-lg-3">
                                ...
                                <p align="center" style="padding-left: 20px; ">(Enter <i class="bi bi-currency-rupee"></i>0
                                    if charges not applicable)</p>
                                <div class="col-12">
                                    <div class=" d-flex justify-content-start btns mt-3 mb-3">
                                        <button class="btn btn-outline-danger " type="reset">Reset</button>
                                        <button class="btn btn-outline-primary ms-3" type="submit">Apply</button>
                                    </div>
                                </div>
                            </div>
                        </form>
